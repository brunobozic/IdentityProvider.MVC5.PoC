...
namespace IdentityProvider.Models.Domain.Account
{
    ...
    public class RoleGroup : DomainEntity<int>, IActive
    {
        ...
        public virtual ICollection<RoleGroupContainsRole> Roles { get; set; }
        public virtual ICollection<OrgUnitContainsRoleGroup> OrganisationalUnits { get; set; }
        ...
        public List<RoleGroupContainsRole> FetchAssociatedRoles()
        {
            List<RoleGroupContainsRole> roles;

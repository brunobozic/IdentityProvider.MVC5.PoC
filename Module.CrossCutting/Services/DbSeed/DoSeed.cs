...
namespace IdentityProvider.Services.DbSeed
{
    public class DoSeed : IDoSeed
    {
        ...
        public bool Seed()
        {
            ...
            //var rpgrpLink11 = new PermissionGroupOwnsPermission
            //{
            //    Active = true,
            //    ActiveFrom = DateTime.Now,
            //    ActiveTo = DateTime.Now.AddMonths(6),
            ...
            var rpgrpLink12 = new PermissionGroupOwnsPermission
            {
                Active = true,
                ActiveFrom = DateTime.Now,
                ActiveTo = DateTime.Now.AddMonths(6),
            ...
            var rpgrpLink13 = new PermissionGroupOwnsPermission
            {
                Active = true,
                ActiveFrom = DateTime.Now,
                ActiveTo = DateTime.Now.AddMonths(6),
            ...
            var rpgrpLink14 = new PermissionGroupOwnsPermission
            {
                Active = true,
                ActiveFrom = DateTime.Now,
                ActiveTo = DateTime.Now.AddMonths(6),
            ...
            var rpgrpLink15 = new PermissionGroupOwnsPermission
            {
                Active = true,
                ActiveFrom = DateTime.Now,
                ActiveTo = DateTime.Now.AddMonths(6),
            ...
            //_context.PermissionGroupOwnsPermission.Add(rpgrpLink11);
            ...
            var rpgrpLink21 = new PermissionGroupOwnsPermission
            {
                Active = true,
                ActiveFrom = DateTime.Now,
                ActiveTo = DateTime.Now.AddMonths(6),
            ...
            var rpgrpLink22 = new PermissionGroupOwnsPermission
            {
                Active = true,
                ActiveFrom = DateTime.Now,
                ActiveTo = DateTime.Now.AddMonths(6),
            ...
            var rpgrpLink23 = new PermissionGroupOwnsPermission
            {
                Active = true,
                ActiveFrom = DateTime.Now,
                ActiveTo = DateTime.Now.AddMonths(6),
            ...
            var store2 = new RoleStore<ApplicationRole>(_context);
            var manager2 = new ApplicationRoleManager(store2, _context);
            ...
            if (!_context.Users.Any(u => u.UserName == "bruno.bozic@gmail.com"))
            {
                var store = new UserStore<ApplicationUser>(_context);
                var manager = new Microsoft.AspNet.Identity.UserManager<ApplicationUser>(store);
                var user = new ApplicationUser
                {
                    Id = Guid.NewGuid().ToString(),
                    UserName = "bruno.bozic@gmail.com",
                    FirstName = "Bruno",
                    LastName = "Božić",
                    Active = true,
                    ActiveFrom = DateTime.Now,

...
namespace IdentityProvider.Repository.EF.Migrations
{
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                    "Organization.RoleGroupContainsRole",
                    c => new
                    {
                        Id = c.Int(false, true),
            ...
            CreateTable(
                    "Organization.OrgUnitContainsRoleGroup",
                    c => new
                    {
                        Id = c.Int(false, true),
            ...
            CreateTable(
                    "Organization.EmployeeBelongsToOrgUnit",
                    c => new
                    {
                        Id = c.Int(false, true),
                        OrganizationalUnitId = c.Int(false),
            ...
            CreateTable(
                    "Organization.OrgUnitContainsRole",
                    c => new
                    {
                        Id = c.Int(false, true),
                        OrganizationalUnitId = c.Int(false),
            ...
            CreateTable(
                    "Application.PermissionGroupOwnsPermission",
                    c => new
                    {
                        Id = c.Int(false, true),
            ...
            CreateTable(
                    "Organization.RoleContainsPermissionGroup",
                    c => new
                    {
                        Id = c.Int(false, true),
                        ApplicationRoleId = c.String(maxLength: 128),
        ...
        {
            DropForeignKey("Organization.RoleContainsPermissionGroup", "PermissionGroupId",
                "Application.PermissionGroup");
            DropForeignKey("Organization.RoleContainsPermissionGroup", "ApplicationRoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("Application.PermissionGroupOwnsPermission", "PermissionGroupId",
                "Application.PermissionGroup");
            DropForeignKey("Application.PermissionGroupOwnsPermission", "Permission_Id", "Resource.Permissions");
            DropForeignKey("Organization.OrgUnitContainsRole", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("Organization.OrgUnitContainsRole", "OrganizationalUnitId", "Organization.Unit");
            ...
            DropForeignKey("Organization.RoleGroupContainsRole", "RoleGroupId", "Organization.RoleGroup");
            DropForeignKey("Organization.OrgUnitContainsRoleGroup", "RoleGroupId", "Organization.RoleGroup");
            DropForeignKey("Organization.OrgUnitContainsRoleGroup", "OrganizationalUnitId", "Organization.Unit");
            DropForeignKey("Organization.OrgUnitContainsRoleGroup", "OrganizationalUnit_Id1", "Organization.Unit");
            DropForeignKey("Organization.OrgUnitContainsRoleGroup", "OrganizationalUnit_Id", "Organization.Unit");
            DropForeignKey("Organization.EmployeeBelongsToOrgUnit", "OrganizationalUnitId", "Organization.Unit");
            DropForeignKey("Organization.EmployeeBelongsToOrgUnit", "EmployeeId", "Organization.Employee");
            DropForeignKey("Organization.RoleGroupContainsRole", "ApplicationRoleId", "dbo.AspNetRoles");
            ...
            DropIndex("Organization.RoleContainsPermissionGroup", new[] {"PermissionGroupId"});
            DropIndex("Organization.RoleContainsPermissionGroup", new[] {"ApplicationRoleId"});
            DropIndex("Application.PermissionGroupOwnsPermission", new[] {"Permission_Id"});
            DropIndex("Application.PermissionGroupOwnsPermission", new[] {"PermissionGroupId"});
            DropIndex("Organization.OrgUnitContainsRole", new[] {"RoleId"});
            DropIndex("Organization.OrgUnitContainsRole", new[] {"OrganizationalUnitId"});
            DropIndex("Account.UserProfile", new[] {"User_Id"});
            DropIndex("dbo.AspNetUserRoles", new[] {"RoleId"});
            DropIndex("dbo.AspNetUserRoles", new[] {"UserId"});
            DropIndex("Organization.EmployeeBelongsToOrgUnit", new[] {"EmployeeId"});
            DropIndex("Organization.EmployeeBelongsToOrgUnit", new[] {"OrganizationalUnitId"});
            DropIndex("Organization.Unit", "IX_OrganisationalUnitName");
            DropIndex("Organization.OrgUnitContainsRoleGroup", new[] {"OrganizationalUnit_Id1"});
            DropIndex("Organization.OrgUnitContainsRoleGroup", new[] {"OrganizationalUnit_Id"});
            DropIndex("Organization.OrgUnitContainsRoleGroup", new[] {"RoleGroupId"});
            DropIndex("Organization.OrgUnitContainsRoleGroup", new[] {"OrganizationalUnitId"});
            DropIndex("Organization.RoleGroup", "IX_RoleGroupName");
            DropIndex("Organization.RoleGroupContainsRole", new[] {"RoleGroupId"});
            DropIndex("Organization.RoleGroupContainsRole", new[] {"ApplicationRoleId"});
            ...
            DropTable("Organization.RoleContainsPermissionGroup");
            DropTable("Application.PermissionGroup");
            DropTable("Application.PermissionGroupOwnsPermission");
            DropTable("Organization.OrgUnitContainsRole");
            DropTable("Account.UserProfile");
            DropTable("dbo.AspNetUserRoles");
            DropTable("Organization.EmployeeBelongsToOrgUnit");
            DropTable("Organization.Unit");
            DropTable("Organization.OrgUnitContainsRoleGroup");
            DropTable("Organization.RoleGroup");
            DropTable("Organization.RoleGroupContainsRole");

...
namespace IdentityProvider.Infrastructure.Logging.Serilog.SQLite.Sinks.SQLite
{
    internal class SQLiteSinkPerformanceLog : BatchProvider, ILogEventSink
    {
        ...
        {
            return new System.Data.SQLite.SQLiteConnectionStringBuilder { DataSource = dbPath}.ConnectionString;
        }
        ...
        {
            var sqlConnection = new System.Data.SQLite.SQLiteConnection(_connString);
            sqlConnection.Open();
            return sqlConnection;
        }

        private void CreateSqlTable(System.Data.SQLite.SQLiteConnection sqlConnection)
        {
            ...
            var sqlCommand = new System.Data.SQLite.SQLiteCommand(sqlCreateText, sqlConnection);
            sqlCommand.ExecuteNonQuery();
        }

        private System.Data.SQLite.SQLiteCommand CreateSqlInsertCommand(System.Data.SQLite.SQLiteConnection connection)
        {
            var sqlInsertText =
            ...
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@timeStamp", DbType.DateTime));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@applicationId", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@instanceId", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@environment", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@OIB", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@subjectId", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@sessionIndex", DbType.String));

            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@url", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@action", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@request", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@response", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@status", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@statusCode", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@browser", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@miliseconds", DbType.Double));

            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@level", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@exception", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@renderedMessage", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@correlationId", DbType.String));
            sqlCommand.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@properties", DbType.String));
        ...
        private System.Data.SQLite.SQLiteCommand CreateSqlDeleteCommand(System.Data.SQLite.SQLiteConnection sqlConnection, DateTimeOffset epoch)
        {
            var cmd = sqlConnection.CreateCommand();
            cmd.CommandText = $"DELETE FROM {_tableName} WHERE Timestamp < @epoch";
            cmd.Parameters.Add(new System.Data.SQLite.SQLiteParameter("@epoch", DbType.DateTime2)
            {

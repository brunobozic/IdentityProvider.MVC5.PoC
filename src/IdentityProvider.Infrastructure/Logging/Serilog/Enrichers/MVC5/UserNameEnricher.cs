...
namespace IdentityProvider.Infrastructure.Logging.Serilog.Enrichers.MVC5
{
    ...
    public class UserNameEnricher : ILogEventEnricher
    {
        ...
        ///     Initializes a new instance of the <see cref="UserNameEnricher" /> class.
        /// </summary>
        /// <param name="anonymousUsername">
        ///     The anonymous username. Leave null if you do not want to use anonymous user names. By
        ///     default it is (anonymous).
        /// </param>
        /// <param name="noneUsername">
        ///     The none username. If there is no username to be found, it will output this username. Leave
        ///     null (default) to ignore non usernames.
        /// </param>

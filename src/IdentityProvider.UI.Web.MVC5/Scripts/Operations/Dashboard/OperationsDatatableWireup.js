...
$(document).ready(function() {
    ...
    // New record
    $("a.OperationsDashboard_OperationsDatatable_create").on("click",
        function(e) {
            e.preventDefault();
    ...
    // Edit record
    $("#OperationsDashboard_OperationsDatatable").on("click",
        "a.OperationsDashboard_OperationsDatatable_edit",
        function(e) {
            e.preventDefault();
    ...
    // Delete a record
    $("#OperationsDashboard_OperationsDatatable").on("click",
        "a.OperationsDashboard_OperationsDatatable_remove",
        function(e) {
            e.preventDefault();
    ...
    $("#submitSearchOperationsMainGrid").on("click",
        function(e) {

...
namespace Module.CrossCutting.LatestAdditions
{
    ...
    public static class IbanValidator
    {
        ...
        /// <typeparam name="cleanText">
        ///     If your IBAN code contains white space and/or not all capital you can pass true to this method.
        ...
        {
            if (iban == null) return new IbanStatus(ValidationMessages.Valid, true);
            ...
            try
            {
                ...
                if (remainer != 1) return new IbanStatus(ValidationMessages.Invalid);

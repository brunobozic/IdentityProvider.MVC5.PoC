...
$(function () {
    ...
    $('input[name="OperationsDashboard_OperationsWidget_DateRange"]').on("cancel.daterangepicker",
        function (ev, picker) {
            // clearing an input
    ...
    $('input[name="OperationsDashboard_OperationsWidget_DateRange"]').on("apply.daterangepicker",
        function (ev, picker) {
    ...
    $('input[name="OperationsDashboard_OperationsWidget_DateRange"]').on("show.daterangepicker",
        function (ev, picker) {

...
$(function () {
    ...
    $('input[name="OperationsDashboard_AuditTrailDatatable_DateRange"]').on("cancel.daterangepicker",
        function (ev, picker) {
            // clearing an input
    ...
    $('input[name="OperationsDashboard_AuditTrailDatatable_DateRange"]').on("apply.daterangepicker",
        function (ev, picker) {
    ...
    $('input[name="OperationsDashboard_AuditTrailDatatable_DateRange"]').on("show.daterangepicker",
        function (ev, picker) {
            // change the selected date range of that picker according to the current values held in hidden form fields

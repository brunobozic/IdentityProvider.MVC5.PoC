...
{
    public class KafkaConsumerKafkaConsumerMaxOffsetEnricher : ILogEventEnricher
    {
        private LogEventProperty _cachedProperty;

        public const string PropertyName = "KafkaConsumerMaxOffset";

        public IKafkaScheduledConsumer _consumer { get; set; }
        public IServiceProvider _serviceProvider { get; }

        public KafkaConsumerKafkaConsumerMaxOffsetEnricher()
        {
        }

        public KafkaConsumerKafkaConsumerMaxOffsetEnricher(IKafkaScheduledConsumer consumer, IServiceProvider serviceProvider)
        {
        ...
        {
            var value = consumer.GetKafkaConsumerMaxOffset();

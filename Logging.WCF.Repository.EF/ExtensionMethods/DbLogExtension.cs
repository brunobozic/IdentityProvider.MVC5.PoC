...
namespace Logging.WCF.Repository.EF.ExtensionMethods
{
    public static class LoggingEventDtoExtension
    {
        ...
        /// <returns></returns>
        public static DatabaseLog ConvertToDbLog(this LoggingEventDto loggingEventDto)
        {
            const string replacementToken = "N/A";
            var myLog = new DatabaseLog();
            ...
            try
            {
                ...
                myLog.DateCreated = loggingEventDto.TimeStamp;
                myLog.UserId = 1;
                ...
                myLog.DateModified = loggingEventDto.TimeStamp;
